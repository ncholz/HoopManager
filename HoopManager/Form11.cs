    ...
    public partial class Form11 : Form
    {
        ...
        private void dgvStatsHistoricas_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                // Cargamos la temporada y la "memorizamos" para saber luego si la has modificado
                ...
                btnGuardar.Text = "Actualizar / Crear Nueva"; // Texto para que sepas que puedes hacer ambas
            }
        }
